...
| Storage and backup                                      | Flash storage from IBM FS9000 series devices                                                                                                                                                                                                                                                                                                                                                                                    | NetWeaver and HANA DB servers primary storage production on Tier 1. Non-Production on Tier 3.               |
|                                                         | [Cloud Object Storage](https://cloud.ibm.com/docs/cloud-object-storage?topic=cloud-object-storage-about-cloud-object-storage) /n [Block storage](https://cloud.ibm.com/docs/vpc?topic=vpc-block-storage-about&interface=ui)|Backup Operational on Veeam Baremetal with local disk. \n Backups with 2nd copy and long term backup archive, application logs, operational logs and audit logs. \n Backint native, daily complete backup + incremental backup|
...
As mentioned earlier, the [Architecture Framework](https://cloud.ibm.com/docs/architecture-framework?topic=architecture-framework-intro)
